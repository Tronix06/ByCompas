package com.bitronix.bycompa.ui.screens.events
        ...
        Column(
            ...
            Surface(
                ...
                Column(
                    ...
                    Text("¿Cuándo es el evento?", fontSize = 18.sp, fontWeight = FontWeight.Black, color = Color.White)
                    Spacer(modifier = Modifier.height(12.dp))
                ...
                Column(
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {},
                            readOnly = true,
                            label = { Text("Nivel del evento", color = Color.White.copy(alpha = 0.7f)) },
